    ...
    try {
        ...
        */
        ...
        if (crmForm.all.new_projecttype.SelectedText == InvestmentTextValue) {
            document.getElementById("tab5Tab").style.display = "inline";
        }
        else {
            document.getElementById("tab5Tab").style.display = "none";
        }
        // END OF INVESTMENT TAB

        if ((crmForm.FormType == CRM_FORM_TYPE_CREATE)) {
            // hide Navigational section
            document.getElementById("tab0").childNodes[0].rows[SectionNumberNavigational].style.display = "none";

            // hide Order Information section
            document.getElementById("tab0").childNodes[0].rows[SectionNumberOrder].style.display = "none";
        }

        if ((crmForm.FormType == CRM_FORM_TYPE_UPDATE)) {
            if (crmForm.all.new_department.SelectedText == 'Navigation') {
                // show Navigational section
                document.getElementById("tab0").childNodes[0].rows[SectionNumberNavigational].style.display = "inline";
            }
            else {
                // hide Navigational section
                document.getElementById("tab0").childNodes[0].rows[SectionNumberNavigational].style.display = "none";
            ...
            if (crmForm.all.statuscode.SelectedText == 'Ordered' ||
                ...
                document.getElementById("tab0").childNodes[0].rows[SectionNumberOrder].style.display = "inline";
            }
            else {
                // hide Order Information section
                document.getElementById("tab0").childNodes[0].rows[SectionNumberOrder].style.display = "none";
...
function new_salestype_onchange() {
    try {
        ...
        var el = document.getElementById('new_salestype');
        if (el) {
...
function new_tender_onchange() {
    try {
        if (crmForm.all.new_tender.DataValue == true) {
    ...
    try {
        ...
        if ((crmForm.FormType == CRM_FORM_TYPE_CREATE)) {
            if (crmForm.all.new_department.SelectedText == 'Navigation') {
                ...
                // show Navigational section
                document.getElementById("tab0").childNodes[0].rows[1].style.display = "inline";
            }
            else {
                // hide Navigational section
                document.getElementById("tab0").childNodes[0].rows[1].style.display = "none";
            }
        }
    }
    catch (e) {
