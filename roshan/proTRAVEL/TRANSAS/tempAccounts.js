...
accountMain.OnLoadForm = function (cntx) {
    ...
    try {
        ...
        // Hides EI tab if Account's industrycode is not Maritime educational institutions
        ...
        setTimeout(function () {
            ...
            if (parent.Xrm.Page.getAttribute("customertypecode").getSelectedOption().text == "Dealer/Service agent") {
                parent.Xrm.Page.getControl("WebResource_CheckboxBasedList").getObject().contentWindow.window.ConvertDropDownToRadiobuttonList();
            }
