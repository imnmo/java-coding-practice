...
opportunityMain.OnLoadForm = function () {
    ...
    try {
        ...
        function jQueryIsReady() {
            ...
            var projectFoldersIFrame = Xrm.Page.ui.controls.get("IFRAME_JetProjectFoldersV5");
            if (projectFoldersIFrame != null) {
                projectFoldersIFrame.setSrc("https://www.heise.de");
            }
