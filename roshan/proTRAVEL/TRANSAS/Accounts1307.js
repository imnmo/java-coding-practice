        ...
        setTimeout(function () {
            ...
            if (customerTypeCode.getText() != null) {
                if (customerTypeCode.getText() == AgentTextValue) {
                    Xrm.Page.ui.tabs.get("Dealer Areas of Activity").sections.get("Dealer Areas of Activity_section_1").setVisible(true);
                } else {
                    Xrm.Page.ui.tabs.get("Dealer Areas of Activity").sections.get("Dealer Areas of Activity_section_1").setVisible(false);
                }
            }
            /* 
