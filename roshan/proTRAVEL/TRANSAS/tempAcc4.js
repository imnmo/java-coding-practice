...
accountMain.OnLoadForm = function (cntx) {
    ...
    try {
        ...
        if (industryCode.getSelectedOption() ! = null) {
            if (industryCode.getSelectedOption().text != "Maritime educational institutions") {
        ...
        if (industryCode.getSelectedOption() ! = null) {
            if (industryCode.getSelectedOption().text != "Shipping / Shipmanagement Company") {
        ...
        if (customerTypeCode.getSelectedOption() ! = null) {
            if (customerTypeCode.getSelectedOption().text !== "Customer - Vessel") {
        ...
        if (customerTypeCode.getSelectedOption() ! = null) {
            if ((customerTypeCode.getSelectedOption.text != AgentTextValue) || (customerTypeCode.getText() != HubTextValue)) {
                if (Xrm.Page.ui.tabs.get("Vessel"))
        ...
        setTimeout(function () {
            ...
            if (agentNavProducts != null) {
                if (agentNavProducts.getValue()) {
                    ...
                    //TODO NAV product support Section doesnt exist!
            ...
            if (customerTypeCode.getSelectedOption() ! = null) {
                if (customerTypeCode.getSelectedOption.getText() == VesselTextValue) {
                    if (Xrm.Page.ui.tabs.get("Vessel"))
            ...
            //show Agent Information tab with checkbox only when it is dealer/service agent
            if (customerTypeCode.getSelectedOption() ! = null) {
                if (customerTypeCode.getSelectedOption().text == AgentTextValue) {
                    Xrm.Page.ui.tabs.get("Details").sections.get("Agent Information").setVisible(true);
                }
            }
